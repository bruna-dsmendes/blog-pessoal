...
- [Relacionamentos Mapeados](#-relacionamentos-mapeados)
- [Estrutura de Endpoints](#-estrutura-de-endpoints-api-routes)
...
- **Segurança Avançada:** Autenticação de usuários, criptografia de senhas com `BCrypt` e geração de tokens de acesso para proteção de rotas.
...
| `tema_id`   | BigInt       | Chave Estrangeira (`tb_temas`)           |
| `usuario_id`| BigInt       | Chave Estrangeira (`tb_usuarios`)        |
...
1. Abra o seu Insomnia ou Postman.
2. Faça primeiro a requisição de Cadastro de Usuário (`POST /usuarios/cadastrar`).
3. Realize o Login (`POST /usuarios/logar`) para receber o Token JWT ou utilize o mecanismo de Basic Auth com suas credenciais para liberar o acesso às demais rotas de Postagens e Temas.

## 🧑‍💻 Autor

Bruna Mendes - [https://github.com/bruna-dsmendes](https://github.com/bruna-dsmendes)
